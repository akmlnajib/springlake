        ...
        <div class="card-body">
            <div class="panel-container">
                <div class="bootstrap-table">
                    <h5 class="text-green">Nilai Keputusan</h5>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                while ($a = mysqli_fetch_array($data)) {
                                    ...
                                    while ($result = mysqli_fetch_array($query)) {
                                        // Pemangkatan dari nilai kriteria
                                        $hsl_pangkat = pow($result['nama_sub'], 2);
                                        $sum_pangkat += $hsl_pangkat;
                                        // Akar pemangkatan dari nilai pangkat yang diambil dari kriteria
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                while ($a = mysqli_fetch_array($data)) {
                                    ...
                                    $nm_bobot = $a['bobot_kriteria'] / $result['sum_bobot'];
            ...
            <table class="table table-bordered">
                ...
                END AS nilai
                FROM tbl_kriteria nk
                LEFT JOIN tbl_normalisasi n ON nk.id_kriteria = n.id_kriteria
                WHERE nk.id_kriteria IN (SELECT id_kriteria FROM tbl_normalisasi WHERE id_alternatif = '" . $id_alternatif . "')
                GROUP BY nk.id_kriteria");
            ...
            <a class="btn btn-success" href='./?page=hasil'>Kembali</a>
        </div>
    </div>