...
if (isset($_POST['simpan'])) {
    ...
    if (empty($nama_kriteria)) {
        ...
        $query = "INSERT INTO tbl_kriteria (nama_kriteria, bobot_kriteria, sifat) VALUES (?, ?, ?)";
        ...
        if ($stmt) {
            ...
            if ($result) {
                ...
                $values = array(
                    "($id_kriteria, 'Sangat Baik Sekali', 5)",
                    "($id_kriteria, 'Sangat Baik', 4)",
                    "($id_kriteria, 'Baik', 3)",
                    "($id_kriteria, 'Kurang Baik', 2)",
                    "($id_kriteria, 'Baik Sekali', 1)"
                );
